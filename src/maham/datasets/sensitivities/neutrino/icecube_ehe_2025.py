...
@register_dataset
class IceCubeEHESensitivity2025(NeutrinoSpectrumDataset):
    metadata = DatasetMetadata(
        id="icecube.ehe.sensitivity.2025",
        title="IceCube 12.6-year EHE neutrino sensitivity",
        experiment="IceCube",
        messenger="neutrino",
        data_type="sensitivity",
        description="All-flavor differential neutrino sensitivity from the IceCube 12.6-year extremely-high-energy neutrino search.",
        year=2025,
        ...
        notes=("The native result is an all-flavor differential sensitivity.", "The sensitivity is the expected limit for a null observation.", "The official source file also contains the observed differential limit in its second column.", "load_raw() preserves both published curves; load() returns only the sensitivity."),
        tags=("IceCube", "EHE", "sensitivity", "neutrino", "flux"),
    )
    ...
    def standardize(self, raw: Table) -> QTable:
        ...
        table["E2phi"] = np.asarray(raw["sensitivity_E2phi"], dtype=float) * E2phi_unit
        ...
        table.meta["sensitivity_type"] = "null_observation_expected_limit"
